...
import com.example.lythuyetgiaothong.adapters.LawAdapter;
...
public class CarActivity extends AppCompatActivity {
    ...
    private void defineAdapter() {
        ...
        if (b.get("lawPos").equals("0")) {
            ...
            itemAdd(R.drawable.img_7, "Không chấp hành hiệu lệnh, chỉ dẫn của biển báo hiệu, vạch kẻ đường khi đi qua đường ngang, cầu chung", "Phạt tiền từ 800.000 đồng đến 1.000.000 đồng", "cascas");
        ...
        if (b.get("lawPos").equals("1")) {
            ...
            itemAdd(R.drawable.img_7, "Quay đầu xe ở phần đường dành cho người đi bộ qua đường, trên cầu, đầu câu, ngâm, gầm cầu vượt", "Phạt tiền từ 400.000 đồng đến 600.000 đồng", "cascas");
        ...
        if (b.get("lawPos").equals("2")) {
            ...
            itemAdd(R.drawable.img_7, "Dừng xe, đỗ xe không sát mép đường phía bên phải theo chiều đi ở nơi đường có lề đường hẹp hoặc không có lề đường", "Phạt tiền từ 400.000 đồng đến 600.000 đồng", "cascas");
            ...
            itemAdd(R.drawable.img_8, "Khi dừng xe, đỗ xe không có tín hiệu báo cho người điều khiển phương tiện khác biết", "Phạt tiền từ 200.000 đồng đến 400.000 đồng", "cascas");
            ...
            itemAdd(R.drawable.img_10, "Dừng xe, đỗ xe trên phần đường xe chạy ở đoạn đường ngoài đô thị nơi có lề đường rộng ", " Phạt tiền từ 200.000 đồng đến 400.000 đồng", "cascas");
            itemAdd(R.drawable.img_9, "Phạt tiền từ 400.000 đồng đến 600.000 đồng Xem chi tiết Dừng xe, đỗ xe không sát mép đường phía bên phải theo chiều đi ở nơi đường có lề đường hẹp hoặc không có lề đường", "Phạt tiền từ 400.000 đồng đến 600.000 đồng", "cascas");
            itemAdd(R.drawable.img_8, "Dừng xe, đỗ xe ngược với chiều lưu thông của làn đường", "Phạt tiền từ 400.000 đồng đến 600.000 đồng", "cascas");
            itemAdd(R.drawable.img_10, "Dừng xe, đỗ xe trên dải phân cách cố định ở giữa hai phần đường xe chạy", " Phạt tiền từ 400.000 đồng đến 600.000 đồng", "cascas");
        ...
        if (b.get("lawPos").equals("3")) {
            ...
            itemAdd(R.drawable.img_7, "Điều khiển xe lắp đặt, sử dụng còi vượt quá âm lượng theo quy định", "Phạt tiền từ 2.000.000 đồng đến 3.000.000 đồng", "cascas");
        ...
        if (b.get("lawPos").equals("4")) {
            ...
            itemAdd(R.drawable.img_7, "Không tuân thủ quy định về khoảng cách an toàn đối với xe chạy liền trước khi chạy trên đường cao tốc", "Phạt tiền từ 3.000.000 đồng đến 5.000.000 đồng", "cascas");
            itemAdd(R.drawable.img_8, "Điều khiển xe chạy quá tốc độ quy định từ 10 km/h đến 20 km/h ", " Phạt tiền từ 3.000.000 đồng đến 5.000.000 đồng", "cascas");
            itemAdd(R.drawable.img_9, "Điều khiển xe chạy quá tốc độ quy định trên 20 km/h đến 35 km/h", "Phạt tiền từ 6.000.000 đồng đến 8.000.000 đồng", "cascas");
            itemAdd(R.drawable.img_10, "Không chú ý quan sát, điều khiển xe chạy quá tốc độ quy định gây tai nạn giao thông", "Phạt tiền từ 10.000.000 đồng đến 12.000.000 đồng", "cascas");
        ...
        if (b.get("lawPos").equals("6")) {
            ...
            itemAdd(R.drawable.img_7, "Đưa xe ô tô và các loại xe tương tự xe ô tô đã bị cắt, hàn, đục lại số khung, số máy trái quy định tham gia giao thông", "Phạt tiền từ 2.000.000 đồng đến 4.000.000 đồng đối với chủ xe là cá nhân. Phạt tiền từ 4.000.000 đồng đến 8.000.000 đồng đối với chủ xe là tổ chức", "cascas");
            itemAdd(R.drawable.img_9, "Không thực hiện đúng quy định về biển số, quy định về kẻ chữ trên thành xe và cửa xe ô tô và các loại xe tương tự xe ô tô", "Phạt tiền từ 2.000.000 đồng đến 4.000.000 đồng đối với chủ xe là cá nhân. Phạt tiền từ 4.000.000 đồng đến 8.000.000 đồng đối với chủ xe là tổ chức. ", "cascas");
            itemAdd(R.drawable.img_10, "Bán biển số xe ô tô và các loại xe tương tự xe ô tô không phải là biển số do cơ quan nhà nước có thẩm quyền sản xuất hoặc không được cơ quan nhà nước cấp phép", "Phạt tiền từ 1.000.000 đồng đến 2.000.000 đồng đối với cá nhân, từ 2.000.000 đồng đến 4.000.000 đồng", "cascas");
        ...
        if (b.get("lawPos").equals("8")) {
            itemAdd(R.drawable.img_8, "Điều khiển xe trên đường mà trong máu hoặc hơi thở có nồng độ cồn vượt quá 50 miligam đến 80 miligam/100 mililít máu hoặc vượt quá 0,25 miligam đến 0,4 miligam/1 lít khí thở.", "Phạt tiền từ 16.000.000 đồng đến 18.000.000 đồng", "cascas");
            itemAdd(R.drawable.img_9, "Điều khiển xe trên đường mà trong máu hoặc hơi thở có nồng độ cồn vượt quá 80 miligam/100 mililít máu hoặc vượt quá 0,4 miligam/1 lít khí thở", "Phạt tiền từ 30.000.000 đồng đến 40.000.000 đồng.", "cascas");
            itemAdd(R.drawable.img_10, "Không chấp hành yêu cầu kiểm tra về nồng độ cồn của người thi hành công vụ", "Phạt tiền từ 30.000.000 đồng đến 40.000.000 đồng", "cascas");
            ...
            itemAdd(R.drawable.img_10, "Không chấp hành yêu cầu kiểm tra về chất ma túy của người thi hành công vụ ", " Phạt tiền từ 30.000.000 đồng đến 40.000.000 đồng.", "cascas");
        ...
        if (b.get("lawPos").equals("9")) {
            ...
            itemAdd(R.drawable.img_8, "Có giấy phép lái xe nhưng không phù hợp với xe đang điều khiển ", "Phạt tiền từ 3.000.000 đồng đến 4.000.000 đồng", "cascas");
        ...
        if (b.get("lawPos").equals("10")) {
            ...
            itemAdd(R.drawable.img_7, "Mở cửa xe, để cửa xe mở không bảo đảm an toàn ", "Phạt tiền từ 400.000 đồng đến 600.000 đồng ", "cascas");
            itemAdd(R.drawable.img_8, "Giao phương tiện hoặc để cho người làm công, người đại diện điều khiển hoặc trực tiếp điều khiển xe ô tô và các loại xe tương tự xe ô tô quá thời gian quy định tại khoản 1 Điều 65 của Luật giao thông đường bộ ", "Phạt tiền từ 4.000.000 đồng đến 6.000.000 đồng đối với chủ xe là cá nhân. Phạt tiền từ 8.000.000 đồng đến 12.000.000 đồng đối với chủ xe là tổ chức. ", "cascas");
            itemAdd(R.drawable.img_8, "Đưa xe ô tô và các loại xe tương tự xe ô tô quá niên hạn sử dụng tham gia giao thông.", "Phạt tiền từ 4.000.000 đồng đến 6.000.000 đồng đối với chủ xe là cá nhân. Phạt tiền từ 8.000.000 đồng đến 12.000.000 đồng đối với chủ xe là tổ chức.", "cascas");
            itemAdd(R.drawable.img_9, "Buông 2 tay khi điều khiển xe", "Phạt tiền từ 6.000.000 đồng đến 8.000.000 đồng", "cascas");
            itemAdd(R.drawable.img_10, "Dùng chân điều khiển xe", "Phạt tiền từ 6.000.000 đồng đến 8.000.000 đồng", "cascas");

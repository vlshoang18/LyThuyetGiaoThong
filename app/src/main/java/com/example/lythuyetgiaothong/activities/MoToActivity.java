...
public class MoToActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mo_to);
        initUi();
        setRecylerView();
    ...
    private void defineAdapter() {
        ...
        if (b.get("lawPos").equals("1")) {
            ...
            itemAdd(R.drawable.img_7, "Tránh xe không đúng quy định", "Phạt tiền từ 100.000 đồng đến 200.000 đồng", "cascas");
            itemAdd(R.drawable.img_3, "Quay đầu xe nơi không được quay xe", "Phạt tiền từ 100.000 đồng đến 200.000 đồng", "cascas");
            itemAdd(R.drawable.img_8, "Không nhường đường cho xe ngược chiều theo quy định tại đường hẹp,dốc, nơi có chướng ngại vật.", "Phạt tiền từ 100.000 đồng đến 200.000 đồng", "cascas");
            itemAdd(R.drawable.img_9, "Quay đầu xe nơi không được quay xe", "Phạt tiền từ 100.000 đồng đến 200.000 đồng", "cascas");
            itemAdd(R.drawable.img_10, "Chuyển hướng không nhường quyền đi trước cho người đi bộ, xe lăn của người khuyết tật qua đường tại nơi có vạch kẻ đường dành cho người đi bộ", "Phạt tiền từ 100.000 đồng đến 200.000 đồng", "cascas");
        ...
        if (b.get("lawPos").equals("2")) {
            ...
            itemAdd(R.drawable.img_7, "Dừng xe, đỗ xe trên phần đường xe chạy ở đoạn đường ngoài đô thị nơi có lề đường", "Phạt tiền từ 200.000 đồng đến 300.000 đồng", "cascas");
            itemAdd(R.drawable.img_8, "Không tuân thủ các quy định về dừng , đổ xe tại nơi đường bộ giao nhau cùng mức với đường sắt", "Phạt tiền từ 200.000 đồng đến 300.000 đồng", "cascas");
            itemAdd(R.drawable.img_9, "Dừng xe ở nơi có biển “Cấm dừng và đổ xe”", "Phạt tiền từ 200.000 đồng đến 300.000 đồng", "cascas");
            itemAdd(R.drawable.img_10, "Không tuân thủ các quy định về dừng , đổ xe tại nơi đường bộ giao nhau cùng mức với đường sắt", "Phạt tiền từ 200.000 đồng đến 300.000 đồng", "cascas");
        ...
        if (b.get("lawPos").equals("3")) {
            ...
            itemAdd(R.drawable.img_7, "Sử dụng còi không đúng chuẩn kỹ thuật xe", "Phạt tiền từ 100.000 đồng đến 200.000 đồng", "cascas");
        ...
        if (b.get("lawPos").equals("5")) {
            ...
            itemAdd(R.drawable.img_7, "Chở hàng vượt trọng tải thiết kế được ghi giấy đăng ký xe đối với xe có quy định về trọng tải thiết kế", "Phạt tiền từ 400.000 đồng đến 600.000 đồng", "cascas");
            itemAdd(R.drawable.img_8, "Sử dụng ô (dù)", "Phạt tiền từ 100.000 đồng đến 200.000 đồng", "cascas");
        }
        if (b.get("lawPos").equals("6")) {
            ...
            itemAdd(R.drawable.img_7, "Điều khiển xe gắn biển số không đúng quy định", "Phạt tiền từ 100.000 đồng đến 200.000 đồng", "cascas");
            itemAdd(R.drawable.img_9, "Điều khiển xe gắn biển số không rõ chữ số", "Phạt tiền từ 100.000 đồng đến 200.000 đồng", "cascas");
            itemAdd(R.drawable.img_10, "Điều khiển xe gắn biến số bị bẻ cong bị che lấp bị hỏng", "Phạt tiền từ 100.000 đồng đến 200.000 đồng", "cascas");
            ...
            itemAdd(R.drawable.img_7, "Đưa phương tiện không gắn biển số tham gia giao thông", "Phạt tiền từ 800.000 đồng đến 2.000.000 đồng đối với cá nhân từ 1.6000.000 đồng đến 4.000.000 đồng đối với tổ chức", "cascas");
            itemAdd(R.drawable.img_9, "Đưa phương tiện gắn biển số không đúng với giấy đăng ký xe hoặc gắn biển số không do có quan có thầm quyền cấp tham gia giao thông", "Phạt tiền từ 800.000 đồng đến 2.000.000 đồng đối với cá nhân từ 1.6000.000 đồng đến 4.000.000 đồng đối với tổ chức", "cascas");
            itemAdd(R.drawable.img_10, "Điều khiển phương tiện không gắn biển số hoặc tạm thời hoặc biển số tạm thời không do cơ quan có thẩm quyền cấp(nếu có quy định phải gắn biển số tạm thời)", "Phạt tiền từ 3.000.000 đồng đến 5.000.000 đồng", "cascas");
        ...
        if (b.get("lawPos").equals("9")) {
            ...
            itemAdd(R.drawable.img_7, "Có giấy phép lái xe quốc tế do các nước tham gia Công ước về giao thông đường bộ năm 1968 cấp (trừ giấy phép lái xe quốc tế do việt nam cấp) nhưng không mang theo giấy phép lái xe quốc tế", "Phạt tiền từ 800.000 đồng đến 1.200.000 đồng", "cascas");
        ...
        if (b.get("lawPos").equals("10")) {
            ...
            itemAdd(R.drawable.img_7, "Người đang điều khiển xe sử dụng ô , điện thoại, tai nghe trừ thiết bị trợ thính", "Phạt tiền từ 600.000 đồng đến 1.000.000 đồng", "cascas");
            itemAdd(R.drawable.img_8, "Sử dụng chân chóng hoặc vật khác quệt xuống đường khi xe đang chạy", "Phạt tiền từ 2.000.000 đồng đến 3.000.000 đồng", "cascas");
            itemAdd(R.drawable.img_8, "Điều khiển xe đi vào đường cao tốc", "Phạt tiền từ 2.000.000 đồng đến 3.000.000 đồng", "cascas");

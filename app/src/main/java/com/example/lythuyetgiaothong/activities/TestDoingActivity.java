...
import com.example.lythuyetgiaothong.adapters.QuestionTestAdapter;
...
public class TestDoingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_doing1);
        initUi();
        getData();
        makeRecyclerView();
        time();
    ...
    private void getData() {
        Call<QuestionAllResponse> responseDTOCall = (Call<QuestionAllResponse>) ApiClient.apiQuestion().getAllQuestion();

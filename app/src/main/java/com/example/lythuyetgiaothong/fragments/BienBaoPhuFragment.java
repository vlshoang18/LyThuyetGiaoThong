...
public class BienBaoPhuFragment extends Fragment {
    private View bienBao5View;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        bienBao5View = inflater.inflate(R.layout.fragment_bien_bao_5, container, false);
        initUi();
    ...
    private void setRecycleView() {
        ApiClient.getapiSign().getsignAuxiliary().enqueue(new Callback<SignModel>() {
            @Override
    ...
    private void initUi() {
        recyclerView = bienBao5View.findViewById(R.id.rv_bienbao5);
    }

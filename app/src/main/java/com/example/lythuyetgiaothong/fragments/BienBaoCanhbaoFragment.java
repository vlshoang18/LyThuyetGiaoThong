...
public class BienBaoCanhbaoFragment extends Fragment {
    private View bienBao4View;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        bienBao4View = inflater.inflate(R.layout.fragment_bien_bao_4, container, false);
        initUi();
    ...
    private void setRecycleView() {
        ApiClient.getapiSign().getsignWarning().enqueue(new Callback<SignModel>() {
            @Override
    ...
    private void initUi() {
        recyclerView = bienBao4View.findViewById(R.id.rv_bienbao4);
    }

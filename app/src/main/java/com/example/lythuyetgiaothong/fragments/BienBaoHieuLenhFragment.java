...
public class BienBaoHieuLenhFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        bienBao2View = inflater.inflate(R.layout.fragment_bien_bao_2, container, false);
        initUi();
    ...
    private void setRecycleView() {
        ApiClient.getapiSign().getsignCommand().enqueue(new Callback<SignModel>() {
            @Override
    ...
    private void initUi() {
        recyclerView = bienBao2View.findViewById(R.id.rv_bienbao2);
    }

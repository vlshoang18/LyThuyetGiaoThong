...
public class BienBaoChiDanFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        bienBao3View = inflater.inflate(R.layout.fragment_bien_bao_3, container, false);
        initUi();
    ...
    private void setRecycleView() {
        ApiClient.getapiSign().getsignPost().enqueue(new Callback<SignModel>() {
            @Override
    ...
    private void initUi() {
        recyclerView = bienBao3View.findViewById(R.id.rv_bienbao3);
    }
